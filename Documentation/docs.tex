...
\multicolumn{1}{|c|}{} & \multicolumn{1}{c|}{Написание отчета и документации} \\ \cline{2-2} 
\multicolumn{1}{|c|}{} & \multicolumn{1}{c|}{} \\ \hline
 &   \\ \hline
\multicolumn{1}{|c|}{\multirow{5}{*}{Прохоров Юрий}} & \multicolumn{1}{c|}{Реализация анализатора файла формата .WAV} \\ \cline{2-2} 
